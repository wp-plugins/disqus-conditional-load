...
<div class="wrap" id="dsq-wrap">
    <ul id="dsq-tabs">
        <li<?php if (!$show_advanced) echo ' class="selected"'; ?> id="dsq-tab-main" rel="dsq-main"><h4><?php echo (dsq_is_installed() ? dsq_i('Conditional Load') : dsq_i('Install')); ?></h4></li>
        <li<?php if ($show_advanced) echo ' class="selected"'; ?> id="dsq-tab-advanced" rel="dsq-advanced"><h4><?php echo dsq_i('Disqus Settings'); ?></h4></li>
    </ul>
...
?>
	...
	<div class="wrap" style="padding-top: 1.5cm;">
        <h3><?php echo dsq_i('Disqus Conditional Load'); ?> <a href='http://www.joelsays.com/disqus-conditional-load' target='_blank'>Plugin Website</a></h3>
        <p><?php echo dsq_i('Version: 8.0.3') ?></p>
        <?php
